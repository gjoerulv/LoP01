...
M31 is about the first bounded shell/menu and Campaign/Standalone Scenario selection path. It is not full character creation, full settings/mods, full save-slot metadata, Scenario Region Context, fog/scouting, threat preview, item economy, or AI economy.
