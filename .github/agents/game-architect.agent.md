...
- respect the rules in `docs/combat_rules.md`, `docs/game_vision.md`, `docs/game_shell_flow.md`, `docs/presentation_game_feel.md`, `docs/core_loop_rules.md`, `docs/scenario_authoring.md`, `docs/validation_system.md`, `docs/content_schema.md`, and `README_DECISIONS.md`
